...
W('Main.dc.html', 'Frame', board(PAGE('minmax(0, 1fr)', MAIN(`
  ...
  <div style="flex: 1 1 auto; min-height: 0; overflow: hidden;">
    ...
    <div style="padding: 4px 28px 18px;">
      <h3 class="sect">Prayers we&#39;re holding</h3>
      <div style="display: flex; flex-direction: column; gap: 10px;">
        <div style="border: 1px solid #F0F0F2; background: #FFFFFF; border-radius: 16px; padding: 12px 14px;">
          <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 6px;">
            <span style="width: 7px; height: 7px; border-radius: 999px; background: oklch(0.55 0.15 324);"></span>
            <span style="font-size: 11.5px; font-weight: 600; color: oklch(0.55 0.15 324);">Open</span>
            <span style="font-size: 11.5px; color: #A1A1AA;">held 24 days</span>
          </div>
          <div style="font-size: 14px; line-height: 1.55; color: #0A0A0B;">That the question he asked at the BBQ stays open in him — that he&#39;d keep asking it out loud.</div>
        </div>
        <div style="border: 1px solid #F0F0F2; background: #FFFFFF; border-radius: 16px; padding: 12px 14px;">
          <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 6px;">
            <span style="width: 7px; height: 7px; border-radius: 999px; background: oklch(0.55 0.15 324);"></span>
            <span style="font-size: 11.5px; font-weight: 600; color: oklch(0.55 0.15 324);">Open</span>
            <span style="font-size: 11.5px; color: #A1A1AA;">held 9 days</span>
          </div>
          <div style="font-size: 14px; line-height: 1.55; color: #0A0A0B;">For the band back home — that missing it turns into looking for it here.</div>
        </div>
      </div>
    </div>
