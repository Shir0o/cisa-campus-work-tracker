...
export async function pinBoardDoc(boardDoc: Pick<BoardDoc, 'id'>, pinned: boolean, pinnedOrder?: number): Promise<void> {
...
export async function reorderPinnedBoardDocs(orderedDocs: Pick<BoardDoc, 'id'>[]): Promise<void> {
  await Promise.all(
