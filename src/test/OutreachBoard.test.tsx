...
describe('OutreachBoard FAB Accessibility and Responsiveness', () => {
  it('renders fixed "Add Stage" button with correct responsive positioning', () => {
    render(<OutreachBoard />);
    
    // The button has title="Add New Stage"
    const addStageBtn = screen.getByTitle(/Add New Stage/i);
  ...
  it('Accessibility: "Add Stage" button has meaningful text for screen readers', () => {
    render(<OutreachBoard />);
    const addStageBtn = screen.getByTitle(/Add New Stage/i);
