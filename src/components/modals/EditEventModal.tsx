...
import { X, Tag, MapPin, Loader2, CalendarHeart, Users, Ban } from 'lucide-react';
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="p-5 space-y-4">
              ...
              <button
                ...
                className={cn(
                  'w-full flex items-center justify-center gap-2 h-9 rounded-xl text-xs font-medium transition-colors',
                  event.cancelled
              ...
              >
                ...
                {event.cancelled ? t('attendance.undo_cancel', 'Un-cancel this gathering') : t('attendance.cancel_gathering', 'Cancel this gathering')}
              </button>
