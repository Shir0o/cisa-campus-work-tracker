...
export async function savePartners(db: Firestore, pairings: readonly PartnerPairing[]): Promise<void> {
  await setDoc(partnersDoc(db), { pairings: serializePairings(pairings) }, { merge: true });
}
