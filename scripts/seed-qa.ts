...
async function seed() {
  ...
  type SeedContact = {
    ...
    by: string; lastTouch: number; tags: string[]; notes: string;
  ...
  const contacts: SeedContact[] = [
    { id: 'C-0142', name: 'Emerson Ahn', year: 'Sophomore', major: 'Computer Science', pronouns: 'he/him', hall: 'Whitman Hall', phone: '+1 (614) 555-0142', email: 'emerson.ahn@umail.edu', instagram: '@em.ahn', stage: 'regular', joinedDays: 64, by: 'u2', lastTouch: 2, tags: ['small-group:tues', 'freshman-week-21'], notes: 'Plays jazz piano. Brother in Korea. Family is Buddhist; warm but cautious.' },
    { id: 'C-0167', name: 'Lila Okwuosa', year: 'Freshman', major: 'Biology', pronouns: 'she/her', hall: 'Ridgewood House', phone: '+1 (313) 555-0167', email: 'lila.okwuosa@umail.edu', instagram: '@lilaokwu', stage: 'second', joinedDays: 18, by: 'u3', lastTouch: 1, tags: ['welcome-bbq'], notes: 'Met at the welcome BBQ. Asked good questions about who Jesus is.', addedBy: 'u3', reviewed: true },
    { id: 'C-0171', name: 'Rio Marchetti', year: 'Junior', major: 'Economics', pronouns: 'they/them', hall: 'Oak Commons', phone: '+1 (415) 555-0171', email: 'rio.m@umail.edu', instagram: '@riomtti', stage: 'first', joinedDays: 6, by: 'u3', lastTouch: 3, tags: ['org-fair'], notes: 'Curious. Roommate of Jonas (regular). Coffee scheduled Thurs.', addedBy: 'u3', reviewed: false },
    { id: 'C-0188', name: 'Sade Mensah', year: 'Senior', major: 'Psychology', pronouns: 'she/her', hall: 'off-campus', phone: '+1 (404) 555-0188', email: 'sade.mensah@umail.edu', instagram: '@sade.m', stage: 'church', joinedDays: 412, by: 'u1', lastTouch: 4, tags: ['leader-track', 'mentor-cohort'], notes: "Leading our Thursday women's group. Strong family church background." },
    { id: 'C-0195', name: 'Jonas Friedrich', year: 'Junior', major: 'Mech. Engineering', pronouns: 'he/him', hall: 'Oak Commons', phone: '+1 (212) 555-0195', email: 'jonas.f@umail.edu', instagram: '@jonasf', stage: 'regular', joinedDays: 196, by: 'u4', lastTouch: 1, tags: ['small-group:tues', 'intern-team'], notes: "German exchange. Came to faith Spring '25. Wants to lead next year." },
    { id: 'C-0203', name: 'Anika Bose', year: 'Sophomore', major: 'Nursing', pronouns: 'she/her', hall: 'Ridgewood House', phone: '+1 (732) 555-0203', email: 'anika.bose@umail.edu', instagram: '@anikabose', stage: 'regular', joinedDays: 88, by: 'u4', lastTouch: 0, tags: ['small-group:wed'], notes: 'Dad just had heart surgery. Asking deep questions about suffering.', coCreators: ['u3'] },
    { id: 'C-0208', name: 'Theo Vargas', year: 'Freshman', major: 'Architecture', pronouns: 'he/him', hall: 'Whitman Hall', phone: '+1 (787) 555-0208', email: 'theo.vargas@umail.edu', instagram: '@theovrgs', stage: 'first', joinedDays: 9, by: 'u2', lastTouch: 6, tags: ['dorm-outreach'], notes: 'Met in dorm lounge. Catholic background. Lapsed.', addedBy: 'u2', reviewed: false },
    { id: 'C-0212', name: 'Mira Tahir', year: 'Junior', major: 'English Lit', pronouns: 'she/her', hall: 'Briarcliff', phone: '+1 (510) 555-0212', email: 'mira.tahir@umail.edu', instagram: '@miraontheroof', stage: 'second', joinedDays: 22, by: 'u5', lastTouch: 5, tags: ['welcome-bbq'], notes: 'Came from a Muslim family. Has been to two gatherings. Honest.', addedBy: 'u5', reviewed: false, coCreators: ['u3'] },
    { id: 'C-0221', name: 'Wendell Cho', year: 'Senior', major: 'Business', pronouns: 'he/him', hall: 'Stratton Tower', phone: '+1 (646) 555-0221', email: 'wendell.cho@umail.edu', instagram: '@wendelo', stage: 'church', joinedDays: 360, by: 'u1', lastTouch: 7, tags: ['leader-track'], notes: 'Co-leads Wed small group. Looking at grad programs in Chicago.' },
    { id: 'C-0227', name: 'Beatriz Ferraz', year: 'Sophomore', major: 'Music', pronouns: 'she/her', hall: 'Eastfield Apts', phone: '+1 (305) 555-0227', email: 'beatriz.f@umail.edu', instagram: '@bia.ferraz', stage: 'regular', joinedDays: 110, by: 'u4', lastTouch: 2, tags: ['worship-team'], notes: 'Plays guitar. Joined worship team last month.' },
    { id: 'C-0234', name: 'Kofi Boateng', year: 'Freshman', major: 'Math', pronouns: 'he/him', hall: 'Whitman Hall', phone: '+1 (281) 555-0234', email: 'kofi.boateng@umail.edu', instagram: '@kofi.b', stage: 'first', joinedDays: 4, by: 'u3', lastTouch: 2, tags: ['org-fair'], notes: 'Org-fair signup. Said his roommate is asking him about God.', addedBy: 'u3', reviewed: false },
    { id: 'C-0238', name: 'Saoirse Lynch', year: 'Junior', major: 'Linguistics', pronouns: 'she/her', hall: 'Briarcliff', phone: '+1 (617) 555-0238', email: 'saoirse.l@umail.edu', instagram: '@saoirse.l', stage: 'second', joinedDays: 31, by: 'u5', lastTouch: 8, tags: [], notes: 'Skeptical but kind. Friends with Beatriz.' },
    { id: 'C-0244', name: 'Hugo Delacroix', year: 'Sophomore', major: 'Civil Eng.', pronouns: 'he/him', hall: 'Eastfield Apts', phone: '+1 (713) 555-0244', email: 'hugo.d@umail.edu', instagram: '@hugod', stage: 'regular', joinedDays: 142, by: 'u2', lastTouch: 1, tags: ['small-group:wed'], notes: 'Quietly steady. Brings food to small group every week.' },
    { id: 'C-0249', name: 'Tomoko Imai', year: 'Freshman', major: 'Sociology', pronouns: 'she/her', hall: 'Ridgewood House', phone: '+1 (818) 555-0249', email: 'tomoko.i@umail.edu', instagram: '@tmkoimai', stage: 'first', joinedDays: 11, by: 'u4', lastTouch: 5, tags: ['welcome-bbq'], notes: 'Exchange from Osaka. Came to one gathering, was very quiet.', addedBy: 'u4', reviewed: true },
    { id: 'C-0253', name: 'Marcus Holloway', year: 'Senior', major: 'Computer Science', pronouns: 'he/him', hall: 'off-campus', phone: '+1 (213) 555-0253', email: 'marcus.h@umail.edu', instagram: '@m.holloway', stage: 'church', joinedDays: 540, by: 'u1', lastTouch: 14, tags: ['mentor-cohort'], notes: 'Graduating in May. Looking at jobs in Seattle.' },
    { id: 'C-0257', name: 'Elena Vasquez', year: 'Sophomore', major: 'Psychology', pronouns: 'she/her', hall: 'Whitman Hall', phone: '+1 (520) 555-0257', email: 'elena.v@umail.edu', instagram: '@elenavz', stage: 'second', joinedDays: 26, by: 'u5', lastTouch: 4, tags: [], notes: "Family church background but hasn't been to church in 3 years." },
    // --- park outreach people ---
    { id: 'C-0601', name: 'Duy Pham', year: 'Sophomore', major: 'Mechanical Engineering', pronouns: '', hall: 'off-campus', phone: '+1 (614) 555-0601', email: '', instagram: '', stage: 'first', joinedDays: 5, by: 'u1', lastTouch: 3, tags: ['outreach', 'park'], notes: 'Stopped for a Bible, stayed twenty minutes. Grew up going to Mass with his grandmother.', addedBy: 'community', reviewed: false },
    { id: 'C-0602', name: 'Chloe Baptiste', year: 'Freshman', major: 'Nursing', pronouns: '', hall: 'Stratton Tower', phone: '+1 (614) 555-0602', email: '', instagram: '', stage: 'first', joinedDays: 5, by: 'u3', lastTouch: 5, tags: ['outreach', 'park'], notes: 'Took a booklet on suffering. Her friend died in the spring.', addedBy: 'u3', reviewed: false },
    { id: 'C-0603', name: 'Sam Ortiz', year: 'Junior', major: 'Business', pronouns: '', hall: 'off-campus', phone: '+1 (614) 555-0603', email: '', instagram: '', stage: 'first', joinedDays: 5, by: 'u1', lastTouch: 5, tags: ['outreach', 'park'], notes: 'Runs the loop most afternoons. Said to catch him there rather than text.', addedBy: 'community', reviewed: false },
    { id: 'C-0604', name: 'Aisha Nur', year: 'Senior', major: 'Public Health', pronouns: '', hall: 'Eastfield Apts', phone: '+1 (614) 555-0604', email: '', instagram: '', stage: 'first', joinedDays: 5, by: 'u2', lastTouch: 4, tags: ['outreach', 'park'], notes: 'Asked for a Bible in Somali if we can find one.', addedBy: 'u2', reviewed: false },
    { id: 'C-0605', name: 'Grace Wanjiru', year: 'Sophomore', major: 'Statistics', pronouns: '', hall: 'Briarcliff', phone: '+1 (614) 555-0605', email: '', instagram: '', stage: 'first', joinedDays: 34, by: 'u1', lastTouch: 30, tags: ['outreach', 'park'], notes: 'Came to a Friday gathering two weeks after the park.', addedBy: 'u1', reviewed: false },
    { id: 'C-0606', name: 'Tomas Reyes', year: 'Freshman', major: 'Undeclared', pronouns: '', hall: 'off-campus', phone: '+1 (614) 555-0606', email: '', instagram: '', stage: 'first', joinedDays: 34, by: 'u1', lastTouch: 34, tags: ['outreach', 'park'], notes: "Gave his number readily. Nobody has rung it.", addedBy: 'community', reviewed: false },
    { id: 'C-0607', name: 'Nadia Halim', year: 'Junior', major: 'Architecture', pronouns: '', hall: 'Oak Commons', phone: '+1 (614) 555-0607', email: '', instagram: '', stage: 'first', joinedDays: 63, by: 'u5', lastTouch: 51, tags: ['outreach', 'park'], notes: 'Sat with us on the grass for an hour arguing about Genesis.', addedBy: 'u5', reviewed: false },
  ];
  ...
  for (const [ci, c] of contacts.entries()) {
    ...
    const visibleTo = [...new Set([createdById, addedById, ...coCreators].filter(Boolean))];
  ...
  for (const p of prayers) {
    ...
    const by = PRAYER_ADDED_BY[id] || contactById(contactId)?.by || 'u1';
